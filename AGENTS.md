...
- `make setup-prod`: produktive Werte mit TLS-/Domain-Feldern (`scope=prod`) und vorgelagerter Server-Prüfung via `scripts/check-server-tools.sh` (Docker, Compose, Git, Node.js/npm, make/build-essential).
